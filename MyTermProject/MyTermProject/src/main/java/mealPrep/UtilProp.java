...
public class UtilProp {
   ...
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\Noah\\eclipse-workspace\\MyTermProject\\src\\main\\webapp\\config.properties";
   static String _PROP_FILENAME_OSX_LOCAL = "/YOUR_PATH/webproject/WebContent/config.properties";
   // * Remote server path
   static String _PROP_FILENAME_REMOTE = "/var/lib/tomcat9/webapps/MyTermProject/config.properties";
